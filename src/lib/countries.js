// ISO 3166-1 alpha-2 country list, used by the shipping-zone region picker and
// the tax rate table so admins select real country codes instead of typing
// free text that can silently fail to match (e.g. "Pakistn").
...
export const COUNTRY_NAMES_BY_CODE = Object.fromEntries(COUNTRIES.map(c => [c.code, c.name]));

export function countryName(code) {
  if (!code) return "";
  return COUNTRY_NAMES_BY_CODE[code.toUpperCase()] || code;
}
