    ...
    <section className="container mx-auto px-2 sm:px-4 md:px-8 py-2 md:py-4 overflow-hidden relative">
      <div className="bg-white border border-black/5 rounded-[32px] md:rounded-[40px] shadow-sm overflow-hidden py-16 md:py-20 px-6 md:px-16 relative z-10">
        ...
        <div className="flex flex-col items-center">
          <Link href="/write-review" className="group relative overflow-hidden bg-black text-white px-8 md:px-12 py-3.5 md:py-4.5 rounded-full font-bold text-[9px] md:text-xs uppercase tracking-[0.3em] shadow-xl transition-all active:scale-95 inline-flex items-center">
